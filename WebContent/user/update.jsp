				...
				<form class="row contact_form" action="/blog/user?cmd=update" method="post" onsubmit="return validateCheck()">
					...
					<div class="col-md-10">
						<div class="form-group">
							...
							<input type="text" class="form-control" value="${sessionScope.user.address}" id="roadFullAddr" name="address" placeholder="도로명 주소가 자동 입력됩니다." required="required" readonly>
						</div>
					</div>
					<div class="col-md-2">
